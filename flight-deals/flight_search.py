...
# talks to Amadeus: get token, search city IATA, search offers for a single day
# (then loop day-by-day to cover “tomorrow → +6 months”)
...
FLIGHT_ENDPOINT = "https://test.api.amadeus.com/v1/shopping/flight-dates" # Flight Cheapest Date Search
...
class FlightSearch:
    ...
    def _get_new_token(self):
        ...
        :return: str: The new access token obtained from the API response.
        """
        ...
        response = requests.post(url=AMADEUS_URL_TOKEN, headers=headers, data=body)
    ...
    def check_flights(self, origin_city_code, destination_city_code, max_price):  # from_time, to_time,
        """
