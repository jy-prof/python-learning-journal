...
# a tiny class + a find_cheapest_flight(json) helper to extract price,
# origin_airport, destination_airport, out_date, return_date
# (and return an N/A object when nothing found).
...
class FlightData:
    ...
    def find_cheapest_flight(data):
        ...
        :return: FlightData: An instance of the FlightData class representing the cheapest flight found, or a FlightData instance where all fields are 'NA' if no valid flight data is available.
        ...
        # start FlightData with the first flight for comparison
